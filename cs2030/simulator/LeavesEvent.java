...
class LeavesEvent extends Event {
    ...
    /**
     * Constructor of LeaveEvent The time associated with this event is the arrival
     * time of the customer as that is the time the customer leaves as well
     * 
    ...
    public String toString() {
        return String.format("%.3f", this.time) + " " + this.getCustomerInvolved().getID() + " leaves";
    }
}